...
//		  statesMap.put(state.getText().toLowerCase(), null);
//	  }
//	  System.out.println("States updated----"+statesMap);
//  }
//  
//  @Test(dataProvider="states")
//  public void verifyStates(String data) {
//	  getStates();
//	  Assert.assertTrue(statesMap.keySet().contains(data));
//  }
//  
...
//	  if(statesMap.keySet().contains(state)) {
...
//			  //stateObj = new State(state, citiesMap);
//		  }
